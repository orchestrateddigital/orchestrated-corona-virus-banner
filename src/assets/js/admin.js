jQuery( document ).ready( function ( $ ) {
  ...
  $( document ).on( 'change, keypress', '[name=orchestrated_corona_virus_banner_message_title]', ocvb_title_changed );
  $( document ).on( 'change, keypress', '[name=orchestrated_corona_virus_banner_message_text]', ocvb_message_changed );
  ...
  $( document ).on( 'change, keypress', '[name=orchestrated_corona_virus_banner_external_link]', ocvb_external_link_changed );
  $( document ).on( 'change, keypress', '[name=orchestrated_corona_virus_banner_link_text]', ocvb_link_text_changed );
